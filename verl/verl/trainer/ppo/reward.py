...
def get_custom_reward_fn(config, reward_type="train"):
    ...
    elif reward_type == "val":
        reward_fn_config = config.get("custom_val_reward_function") or {}
    else:
    ...
    # this is a workaround to support async reward function
    # Check if the raw function is async
